#Subsampling scheme for AWI231-11_sv1058
...
start.date.time<-ISOdatetime(2014, 12, 20, 0, 0, 0, tz="GMT")
end.date.time<-ISOdatetime(2015, 11, 30, 23, 0, 0, tz="GMT") 
