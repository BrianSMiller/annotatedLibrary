...
params.startDate = datenum('29-Jan-2015 00:00:00');
params.endDate = datenum('29-Jan-2016 03:00:00');

% Pick a random starting point
startHour = floor(rand(1)*25)

% Output from above, but hard-coded here to be able to reproduce the result
params.startHour = 1112; 
